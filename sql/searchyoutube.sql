...
--
-- Host: localhost
-- Generation Time: Sep 18, 2013 at 12:44 PM
...
INSERT INTO `settings` (`id`, `user`, `video`, `message`) VALUES
(1, 2, 'http://www.youtube.com/watch?v=giUk9leseBs', 'This is test email.');
...
ALTER TABLE `settings`
  ADD CONSTRAINT `settings_ibfk_1` FOREIGN KEY (`user`) REFERENCES `user` (`id`) ON DELETE CASCADE;
